...
struct CloudFrontMiddlewareTests {
    ...
    @Test func signRequestPolicyReturnsExpected() throws {
        ...
        let unwrappedPrivateKey = try #require(privateKey, "Could not load private key")

        let generatedSignature = signRequestPolicy(requestPolicy, withKey: unwrappedPrivateKey)
    ...
    @Test func assembleCloudFrontRequestReturnsExpected() throws {
